    ...
    return (
        <div>
            <div class="text-center text-gray-800 dark:text-white py-24 px-6">
                <h1 class="text-4xl md:text-5xl xl:text-6xl font-bold tracking-tight mb-12">Task Management that's a breeze<br /><span class="text-blue-600">Even for toddlers</span></h1>
