        ...
        <section className=" grid grid-cols-1 gap-x-10 md:px-10 md:grid-cols-2 items-center dark:bg-gray-900">
            ...
            <div class="w-full p-4 bg-white  rounded-lg sm:p-6 md:p-8 dark:bg-gray-900 ">
                <form class="space-y-6" action="#">
                    <h5 class="text-2xl text-center font-medium text-gray-900 dark:text-white">Sign up</h5>
                    ...
                    <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                        Already Have an Account? <Link to='/login' class="text-blue-700 hover:underline dark:text-blue-500">Log in Now</Link>
                    </div>
